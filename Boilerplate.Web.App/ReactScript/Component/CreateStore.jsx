...
export default class CreateStore extends Component {
    ...
    render() {
        ...
        return (
            ...
            <Modal trigger={<Button size='big' active color='blue' onClick={this.handleOpen}>New Store</Button>}
                ...
                {!this.state.complete ?
                    <Modal.Actions>
                        ...
                        <Button positive icon='checkmark' labelPosition='right' content="Create" onClick={this.createstoreForm} />
                    </Modal.Actions>
                    : null}
